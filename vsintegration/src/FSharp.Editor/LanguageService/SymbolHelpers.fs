...
module internal SymbolHelpers =
    ...
    /// One core is left to the thread that has to stay responsive: every search shares this budget,
    /// including the C# and Visual Basic searches that run alongside the F# ones.
