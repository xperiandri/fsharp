...
module internal CrossLanguageSymbolNavigation =
    ...
    let tryFindFileLocation
        ...
        =
        cancellableTask {
            match! tryFindDeclaration itemsCache solution assemblyName documentationCommentId with
            | ValueNone -> return ValueNone
    ...
    interface IFSharpCrossLanguageSymbolNavigationService2 with
        member _.TryGetNavigableFileLocationAsync
            ...
            cancellableTask {
                ...
                | workspace ->
                    let! location =
                        CrossLanguageSymbolNavigation.tryFindFileLocation
                            itemsCache
                            workspace.CurrentSolution
                            assemblyName
                            documentationCommentId
